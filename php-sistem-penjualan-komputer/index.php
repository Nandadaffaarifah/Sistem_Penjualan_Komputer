...
<html lang="en">
    <head>
        ...
        <title>Purchase - Dipo Comp</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">Dipo Comp</a>
            <!-- Sidebar Toggle-->
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Welcome to Dipo Comp. website, buyers!</li>
                        </ol>
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body"><h4>Order Quantity: <?=$h2;?></h4></div>
                                    </div>
                                </div>
                        </div>
                                    ...
                                    ?>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-header">
                                                <h4 class="modal-title">Delete Purchase Data</h4>
